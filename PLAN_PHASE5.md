...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/data/model/SearchResult.kt`
  - `android/app/src/main/java/com/outlinergod/app/data/model/SearchResultGroup.kt`
  - `android/app/src/main/java/com/outlinergod/app/data/repository/SearchRepository.kt`
  - `android/app/src/main/java/com/outlinergod/app/data/repository/impl/SearchRepositoryImpl.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/SearchViewModel.kt`
  - `android/app/src/main/java/com/outlinergod/app/di/RepositoryModule.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/SearchViewModelTest.kt` using `runTest` with `StandardTestDispatcher` and `MainDispatcherRule`; mock `SearchRepository` with MockK:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/SearchScreen.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/BookmarkListViewModel.kt`
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/BookmarkListViewModelTest.kt` using `runTest` + `StandardTestDispatcher`, mocked `BookmarkDao`, `HttpClient`, `HlcClock`, `AuthRepository`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/BookmarkListScreen.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/data/repository/impl/SyncRepositoryImpl.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/data/repository/SyncRepositoryBookmarkTest.kt` using `runTest`, in-memory Room DB (Robolectric), mocked Ktor client:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/data/model/BacklinkItem.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/BacklinkViewModel.kt`
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/BacklinkViewModelTest.kt` using `runTest`, `StandardTestDispatcher`, mocked `HttpClient`, `SettingsDao`, `AuthRepository`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/component/BacklinkSection.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/NodeEditorViewModel.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/component/NodeContextMenu.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/NodeEditorScreen.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/NodeEditorViewModelConvertTest.kt` using `runTest`, mocked `HttpClient`, `NodeDao`, `DocumentDao`, `HlcClock`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/ExportViewModel.kt`
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/ExportViewModelTest.kt` using `runTest`, `StandardTestDispatcher`, mocked `HttpClient`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/component/ExportBottomSheet.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/NodeEditorScreen.kt` (updated)
- **How to test**: Manual acceptance criteria:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/NodeEditorViewModel.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/NodeEditorScreen.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/NodeEditorImageUploadTest.kt` using `runTest`, mocked `Compressor` (via Mockk `mockkStatic`), mocked `HttpClient`, mocked `ContentResolver`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/viewmodel/SettingsViewModel.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/data/repository/impl/SyncRepositoryImpl.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/viewmodel/SettingsViewModelSyncTest.kt` using `runTest`, in-memory Room (Robolectric), mocked `HlcClock`, mocked `SyncRepositoryImpl`:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/sync/SyncWorker.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/sync/SyncWorkerLwwTest.kt` using `runTest`, in-memory Room (Robolectric), mocked Ktor client configured to return specific payloads:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/data/repository/OfflineRepository.kt`
  - `android/app/src/main/java/com/outlinergod/app/data/repository/impl/OfflineRepositoryImpl.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/component/OfflineBanner.kt`
  - `android/app/src/main/java/com/outlinergod/app/di/NetworkModule.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/DocumentListScreen.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/NodeEditorScreen.kt` (updated)
- **How to test**: `android/app/src/test/java/com/outlinergod/app/data/repository/OfflineRepositoryTest.kt` using `runTest`, mocked `ConnectivityManager` and `NetworkCallback` captured via `argumentCaptor`:
...
- **How to test**: `android/app/src/test/java/com/outlinergod/app/ui/navigation/AppNavHostRoutesTest.kt` using plain JUnit4 + `TestNavHostController` (no Compose UI framework required):
  ...
  3. `deep link pattern contains outlinergod scheme` — assert the `uriPattern` string registered for NODE_EDITOR contains `"outlinergod://document/"`.
