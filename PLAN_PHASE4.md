...
- **Output artifact**:
  ...
  - `android/app/src/main/java/com/outlinergod/app/ui/navigation/AppRoutes.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/NodeEditorScreen.kt` (updated)
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/login/LoginViewModel.kt`
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/login/LoginViewModelTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/login/LoginScreen.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/navigation/AppNavHost.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/login/LoginScreenTest.kt`
  - No Compose UI tests in this phase. Tests verify structural correctness.
  - **Test cases**:
    1. `loginScreenKt_classExists_inLoginPackage` — `Class.forName("com.gmaingret.outlinergod.app.ui.screen.login.LoginScreenKt")`; assert non-null and no `ClassNotFoundException`.
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/documentlist/DocumentListViewModel.kt`
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/documentlist/DocumentListViewModelTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/documentlist/DocumentListViewModel.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/documentlist/DocumentListSyncTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/mapper/FlatNodeMapper.kt`
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/mapper/FlatNodeMapperTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt`
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModelTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorPersistenceTest.kt`
...
- **What to build**: Create `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorScreen.kt`. Define `@Composable fun NodeEditorScreen(documentId: String, viewModel: NodeEditorViewModel = hiltViewModel())`. In `LaunchedEffect(documentId)`, call `viewModel.loadDocument(documentId)`. Collect state via `viewModel.container.stateFlow.collectAsState()`. When `Loading`, show `CircularProgressIndicator`. When `Success`, render a `Scaffold` with a `TopAppBar` displaying the document title (derived from `documentId` — fetch the document name from `DocumentDao` via a separate `@Composable fun rememberDocumentTitle(documentId: String): State<String>` helper). Render flat nodes as `LazyColumn { items(state.flatNodes, key = { it.entity.id }) { flatNode -> NodeRow(flatNode = flatNode, isFocused = state.focusedNodeId == flatNode.entity.id, onContentChanged = { viewModel.onContentChanged(flatNode.entity.id, it) }, onEnterPressed = { cursor -> viewModel.onEnterPressed(flatNode.entity.id, cursor) }, onBackspaceOnEmpty = { viewModel.onBackspaceOnEmptyNode(flatNode.entity.id) }, onMoveFocus = { viewModel.moveFocus(it) }, onFocusLost = { viewModel.onNodeFocusLost(flatNode.entity.id) }) } }`. Implement `@Composable fun NodeRow(...)` in the same file: uses `Modifier.padding(start = (flatNode.depth * 24).dp)` for indentation; a filled dot `Canvas` glyph on the left; a `BasicTextField(state = rememberTextFieldState(flatNode.entity.content), inputTransformation = EnterKeyInterceptor { cursor -> onEnterPressed(cursor) }, modifier = Modifier.fillMaxWidth())` using `TextFieldState`; apply `MarkdownVisualTransformation` from P0-2 prototype (`com.gmaingret.outlinergod.app.prototype.MarkdownVisualTransformation`) as the `textStyle` source; a directional arrow `IconButton` on the right when `flatNode.hasChildren`. Update `AppNavHost.kt` to replace the `node_editor` placeholder with `NodeEditorScreen(documentId = backStackEntry.arguments?.getString("documentId") ?: "")`.
- **Inputs required**: P4-7, P4-8 (NodeEditorViewModel); P4-6 (FlatNode); P3-14 (AppNavHost); Phase 0 prototype `MarkdownVisualTransformation` from `com.gmaingret.outlinergod.app.prototype` package
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorScreen.kt`
  - `android/app/src/main/java/com/outlinergod/app/ui/navigation/AppNavHost.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorScreenTest.kt`
  - No Compose UI tests. Structural tests only.
  - **Test cases**:
    1. `nodeEditorScreenKt_classExists` — `Class.forName("com.gmaingret.outlinergod.app.ui.screen.nodeeditor.NodeEditorScreenKt")`; assert no exception.
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorScreen.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt` (updated with `onNodeDropped`)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/DragAndDropTest.kt`
...
- **Output artifact**:
  ...
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NodeContextMenuTest.kt`
  - **Test cases**:
...
- **Output artifact**:
  ...
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt` (updated)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NoteEditorTest.kt`
  - **Test cases**:
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorViewModel.kt` (updated)
  - `android/app/src/main/java/com/outlinergod/app/ui/common/SyncStatus.kt` (new — shared enum)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/nodeeditor/NodeEditorSyncTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/ui/screen/settings/SettingsViewModel.kt`
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/ui/screen/settings/SettingsViewModelTest.kt`
...
- **Output artifact**:
  - `android/app/src/main/java/com/outlinergod/app/sync/SyncWorker.kt`
  - `android/app/src/main/java/com/outlinergod/app/sync/SyncScheduler.kt`
  - `android/app/src/main/java/com/outlinergod/app/OutlinerGodApp.kt` (updated with HiltWorkerFactory and SyncScheduler)
  - `android/app/src/main/AndroidManifest.xml` (updated to disable automatic WorkManager init)
- **How to test**:
  - **Test file**: `android/app/src/test/java/com/outlinergod/app/sync/SyncWorkerTest.kt`
